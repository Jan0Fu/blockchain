...
public class BlockInit implements Callable {
    ...
    public BlockInit(int id, long timestamp, String prevHash, List<Message> data, int prefix,
    ...
    public Object call() throws Exception {
        ...
        data.add(new Message(id, 100L, "Blockchain", "miner " + Thread.currentThread().getId(), privateKey).call());
